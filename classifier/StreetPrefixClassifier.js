...
class StreetPrefixClassifier extends WordClassifier {
  ...
  each (span) {
    ...
    if (this.index.hasOwnProperty(span.norm)) {
      ...
      span.classify(new StreetPrefixClassification(confidence, this.index[span.norm]))
      return
    }
    ...
    if (span.contains.final.period && this.index.hasOwnProperty(span.norm.slice(0, -1))) {
      ...
      span.classify(new StreetPrefixClassification(confidence, this.index[span.norm.slice(0, -1)]))
    }
  }
}
